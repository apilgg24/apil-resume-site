...
export function UpworkIcon({ className, size = 18 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
      ...
      aria-hidden
    >
      <path d="M18.561 13.158c-1.102 0-2.135-.467-3.074-1.227l.228-1.076.008-.042c.207-1.143.849-3.06 2.839-3.06 1.492 0 2.703 1.212 2.703 2.703-.001 1.489-1.212 2.702-2.704 2.702zm0-8.14c-2.539 0-4.51 1.649-5.31 4.366-1.22-1.834-2.148-4.036-2.687-5.892H7.828v7.112a2.668 2.668 0 0 1-2.665 2.663 2.668 2.668 0 0 1-2.664-2.663V3.492H0v7.112a5.332 5.332 0 0 0 5.331 5.331 5.332 5.332 0 0 0 5.331-5.331v-1.192c.53 1.013 1.187 2.027 1.984 2.94l-1.68 7.918h2.728l1.214-5.715c1.077.683 2.31 1.13 3.654 1.13 2.974 0 5.397-2.443 5.397-5.417-.001-2.97-2.422-5.25-5.398-5.25z" />
    </svg>
  )
}
...
export function ArrowUpIcon({ className, size = 18 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
